...
#uva.xplant$LiverDonorR11r11r1r1r1.donor.Liver <- r11.donor$Liver 
...
#Xplant <- xplant[-26,c("Year", "Liver", "Liver_DD", "Liver_LD","Kidney", "Kidney_DD", "Kidney_LD", "r11.donor.Liver", "r11.donor.Kidney", "Location")]
