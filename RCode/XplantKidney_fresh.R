...
plot(uva.k.e$Kidney.O - duke.k.e$Kidney.O)
lines(uvake$Kidney.O - dukeke$Kidney.O, col="blue")
lines(uvaduke.e, col="red")
...
uvamcv.lm.e1 <- uvamcv.lm$resid[1:24]

r11k <- r11donor$Kidney[2:25]

uvamcv <- uva$Kidney[2:25] - mcv$Kidney[2:25]
